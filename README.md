...
1. Have an OpenSearch instance running and reachable (default: `localhost:9200`).
2. Install dependencies:
   ```bash
   pip install fastapi uvicorn opensearch-py sentence-transformers pypdf langchain-openai
   ```
3. Create the index and hybrid search pipeline:
   ```bash
...
4. Run the app:
   ...
   ```
5. Open `/docs` for the interactive Swagger UI.
